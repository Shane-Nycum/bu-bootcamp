...
public class ContactTest { 
  ...
  // Shane's test
  @Test
  void getPhone_twoContactsSameName_returnCorrectPhoneNumber() {
    // Arrange
    Contact johnSmithFromNewYork = new Contact("John Smith", "212-555-0001");

    // Act
    Contact johnSmithFromBoston = new Contact("John Smith", "617-555-0001");

    // Assert
    assertEquals("212-555-0001", johnSmithFromNewYork.getPhone());
    assertEquals("617-555-0001", johnSmithFromBoston.getPhone());
  }
} 